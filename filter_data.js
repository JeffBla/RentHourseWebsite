module.exports = {
    ...
    districts:[["中正區","大同區","中山區","松山區","大安區","萬華區","信義區","士林區","北投區","內湖區","南港區","文山區"],
               ...
               ["南竿鄉","北竿鄉","莒光鄉","東引鄉"]],
    types:['整層住家','獨立套房','分租套房','雅房','店面','住辦','商用','廠房','車位','土地','其他'],
    prices:['5000以下','5000~10000','10000~20000','20000~30000','30000~50000','50000以上'],
    others:['刊登身份','建物型態','坪數','樓層','設備','特色','格局','最短租期','性別條件'],
    other_options:[['房東','仲介','代管','代理人'],
                   ['透天','公寓','電梯大樓','別墅'],
                   ['10坪以下','10-20坪','20-30坪','30-40坪','50坪以上'],
                   ['1層','2-6層','6-12層','12層以上'],
                   ['有冷氣','有洗衣機','有冰箱','有熱水器','有網絡'],
                   ['可開伙','可養寵物','近醫院','近超商','有車位','有電梯','包裹代收','垃圾代收'],
                   ['1房','2房','3房','4房以上'],
                   ['1個月','3個月','半年','1年','面議'],
                   ['男女皆可','限男生','限女生']]
};