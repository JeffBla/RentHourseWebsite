  !(function(i, t) {
    typeof exports === 'object' && typeof module === 'object' ? module.exports = t() : typeof define === 'function' && define.amd ? define('TwCitySelector', [], t) : typeof exports === 'object' ? exports.TwCitySelector = t() : i.TwCitySelector = t();
  }(window, () => (function(i) {
    const t = {};
    ...
    return n.m = i, n.c = t, n.d = function(i, t, s) {
      ...
      if (4 & t && typeof i === 'object' && i && i.__esModule) return i;
      const s = Object.create(null);
      if (n.r(s), Object.defineProperty(s, 'default', {
          enumerable: !0,
          value: i
        }), 2 & t && typeof i !== 'string')
        for (const o in i) n.d(s, o, ((t) => i[t]).bind(null, o));
      return s;
    }, n.n = function(i) {
      const t = i && i.__esModule ? function() {
        return i.default;
      } : function() {
        return i;
      };
    ...
    const a = (function() {
      ...
      return t = i, (n = [{
        ...
        value(i, t) {
          let n = '';
          if (i = i || {}, Object.keys(t).forEach((t) => {
    ...
    function h() {
      ...
      return this.options = new a(i, t, {
        ...
        (function() {
          ...
          const i = document.querySelectorAll(`[role=${this.ROLE_ATTR_NAME}]`);
          return Array.prototype.forEach.call(i, function(i) {
            ...
            return t.el = i, t.elCounty = null, t.elDistrict = null, t.elZipcode = null, t = function() {
              return this.options.only = this.el.getAttribute('data-only') ? this.el.getAttribute('data-only').replace(/\s/g, '').split(',') : null, this.options.except = this.el.getAttribute('data-except') ? this.el.getAttribute('data-except').replace(/\s/g, '').split(',') : null, this.options.countyValue = this.el.getAttribute('data-county-value'), this.options.districtValue = this.el.getAttribute('data-district-value'), this.options.hasZipcode = this.el.getAttribute('data-has-zipcode') != null, this.options.hiddenZipcode = this.el.getAttribute('data-hidden-zipcode') != null, this.options.disabled = this.el.getAttribute('data-disabled') != null, this.options.standardWords = this.el.getAttribute('data-standard-words') != null, this.options.bootstrapStyle = this.el.getAttribute('data-bootstrap-style') != null, this;
            }.call(t), r.call(t);
          }, this), i;
        }).call(this);
      }, 0), this;
    ...
    function r() {
      return this.options.lang && this.options.lang === 'en-us' ? this.data = o : this.data = s,
        function() {
          const i = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
          const t = i ? '台' : '臺';
          const n = i ? '臺' : '台';
          this.data.counties = this.data.counties.map((i) => (i.includes(t) ? i.replace(t, n) : i)), this.data.districts.forEach((i, s, o) => {
            o[s][0] = i[0].map((i) => (i.includes(t) ? i.replace(t, n) : i));
          });
        ...
        function() {
          ...
          this.elCounty.classList.add(this.options.countyClassName), this.elCounty.name = this.options.countyFieldName, this.elCounty.id = this.options.countyFieldName, this.options.disabled && this.elCounty.setAttribute('disabled', !0);
          if (function() {
              const i = this.elCounty;
              this.options.lang && this.options.lang === 'en-us' ? i.options.add(new Option('Select County/City', '')) : i.options.add(new Option('縣市', ''));
              for (let t = function() {
                  const i = this.options.only;
                  return typeof i === 'string' ? i : Array.isArray(i) ? i.map((i) => {
                    const t = i.indexOf('@');
                    return t === -1 ? i : i.substring(0, t);
                  }) : null;
                }.call(this), n = function() {
                  const i = this.options.except;
                  return typeof i === 'string' ? i : Array.isArray(i) ? i.filter((i) => i.indexOf('@') === -1) : null;
                }.call(this), s = 0, o = this.data.counties.length; s < o; s++)
                if (!(t && t.indexOf(this.data.counties[s]) === -1 || n && n.indexOf(this.data.counties[s]) !== -1)) {
                  const e = new Option(this.data.counties[s], this.data.counties[s]);
          ...
          this.elDistrict.classList.add(this.options.districtClassName), this.elDistrict.name = this.options.districtFieldName, this.elDistrict.id = this.options.districtFieldName, this.options.disabled && this.elDistrict.setAttribute('disabled', !0);
          if (c.call(this), !this.elZipcode && this.options.hasZipcode) {
            const s = document.createElement('input');
            this.elZipcode = s, i.appendChild(this.elZipcode), this.elZipcode.type = this.options.hiddenZipcode ? 'hidden' : 'text', this.elZipcode.name = this.options.zipcodeFieldName, this.elZipcode.classList.add(this.options.zipcodeClassName), this.elZipcode.readOnly = !0, this.options.lang && this.options.lang === 'en-us' ? this.elZipcode.placeholder = 'ZIP code' : this.elZipcode.placeholder = '郵遞區號', this.elZipcode.size = 3, this.elZipcode.autocomplete = 'off', this.options.disabled && this.elZipcode.setAttribute('disabled', !0);
          }
        ...
        function() {
          const i = function() {
            const i = this.elCounty.querySelector('option:checked');
            const t = i.getAttribute('data-index');
        ...
        function() {
          const i = function() {
            const i = this.elDistrict.querySelector('option:checked');
            const t = i.dataset.zipcode || '';
    ...
    function c() {
      ...
      if (this.options.lang && this.options.lang === 'en-us' ? t.options.add(new Option('Select District', '')) : t.options.add(new Option('區域', '')), !i) return !0;
      for (let n = function(i) {
          let t = this.options.only;
          ...
          return t.forEach((t) => {
            if (t.indexOf(i) !== -1) {
              ...
              return n !== -1 ? s = t.substring(n + 1).split('|') : void 0;
            }
          }), s;
        }.call(this, this.elCounty.value), s = function(i) {
          let t = this.options.except;
          const n = typeof t === 'string';
          if (!n && !Array.isArray(t)) return null;
          n && (t = [t]);
          let s = null;
        ...
        if (!(n && n.indexOf(this.data.districts[i][0][o]) === -1 || s && s.indexOf(this.data.districts[i][0][o]) !== -1)) {
          const a = new Option(this.data.districts[i][0][o], this.data.districts[i][0][o]);
          a.dataset.zipcode = this.data.districts[i][1][o], t.options.add(a);
        } return !0;
    }

    function l() {
      const i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
    ...
    h.prototype.getVersion = function() {
      ...
      return void 0 === t && (t = 0), this.indexOf(i, t) !== -1;
    });
  }])).default));